...
call_notif = FunctionItem("Send a High Priority Call Notification", call_immediate)
msg_notif = FunctionItem("Send a Medium Priority Message Notification", msg_immediate)
