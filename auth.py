...
class MiBand3(Peripheral):
    ...
    def send_custom_alert(self, type):
        ...
        f.write("under char\n")
        #f.write(char)
        #f.write(base_value + phone + "\n")
        char.write(bytes(base_value + phone, 'utf-8'), withResponse=True)
        #char.write(0x03, withResponse=False)
        #f.write("under 0x03qq\n")
        #char.write(0x01, withResponse=True)
        f.write("under char.write\n")
        f.close()
